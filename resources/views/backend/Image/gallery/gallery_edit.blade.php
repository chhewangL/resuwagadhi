...
<div class="card mb-3">
          ...
          <div class="card-body">
          	...
          	<form method="post" action="{{url('admin/gallery/'.$g->id)}}" enctype="multipart/form-data">
          		{{csrf_field()}}
...
<div class="form-group">
    ...
    <input type="file" id="fname" name="image" placeholder="" class="form-control" value="{{$g->image}}">
...
<div class="form-group">
    ...
    <input type="text" id="fname" name="dis" placeholder="" class="form-control" value="{{$g->description}}">
